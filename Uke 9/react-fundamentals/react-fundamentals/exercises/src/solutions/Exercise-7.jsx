...
const MyFirstComponentWithDefaultProps = class extends React.Component {
  render() {
    return (
      <div>
...
const MySecondComponentWithDefaultProps = class extends React.Component {
  render() {
    return (
      <div>
 ...
 * <div></div>
 */
const MyThirdComponentWithDefaultProps = class extends React.Component {
  render() {
    return (
      <div>
