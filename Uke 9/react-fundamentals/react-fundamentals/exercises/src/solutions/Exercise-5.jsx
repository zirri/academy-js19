...
const MyFirstFancyJsxComponent = class extends React.Component {
  render() {
    return (
      <div>
        {this.props.isValid && (
...
const MySecondFancyJsxComponent = class extends React.Component {
  render() {
    return (
      <div>
        {this.props.isActive ? (
...
const MyThirdFancyJsxComponent = class extends React.Component {
  render() {
    return (
      <div>
        {this.props.isReady ? (
