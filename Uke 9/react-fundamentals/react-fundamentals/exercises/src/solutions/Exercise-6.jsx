...
const MyFirstComponentWithPropTypes = class extends React.Component {
  render() {
    return (
      <div>
...
const MyFirstComponentWithPropTypesRequired = class extends React.Component {
  render() {
    return (
      <div>
        <h3>Count: {this.props.count}</h3>
...
const MySecondComponentWithPropTypes = class extends React.Component {
  render() {
    return (
      <div>
...
const MyThirdComponentWithPropTypes = class extends React.Component {
  render() {
    return (
      <div>
