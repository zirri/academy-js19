      ...
      <div>
        ...
        <div className="chapter-2-5">
          <div className="chapter-2-5-1">
            <h3>Solution 5-1: My first fancy JSX component</h3>
          ...
          <div className="chapter-2-5-2">
            <h3>Solution 5-2: My second fancy JSX component</h3>
          ...
          <div className="chapter-2-5-3">
            <h3>Solution 5-3: My third fancy JSX component</h3>
        ...
        <div className="chapter-2-6">
          <div className="chapter-2-6-1">
            <h3>Solution 6-3: My first component with propTypes</h3>
          ...
          <div className="chapter-2-6-2">
            <h3>Solution 6-3: My first component with propTypes (required)</h3>
          ...
          <div className="chapter-2-6-3">
            <h3>Solution 6-3: My second component with propTypes</h3>
          ...
          <div className="chapter-2-6-4">
            <h3>Solution 6-3: My third component with propTypes</h3>
        ...
        <div className="chapter-2-7">
          <div className="chapter-2-7-1">
            <h3>Solution 7-1: My first component with default props</h3>

            <MyFirstComponentWithDefaultProps />
          </div>

          <div className="chapter-2-7-2">
            <h3>Solution 7-2: My second component with default props</h3>

            <MySecondComponentWithDefaultProps />
          </div>

          <div className="chapter-2-7-3">
            <h3>Solution 7-3: My third component with default props</h3>
        ...
        <div className="chapter-2-8">
          <div className="chapter-2-8-1">
            <h3>Solution 8-1: My first component using lifecycle methods</h3>
        ...
        <div className="chapter-2-9">
          <div className="chapter-2-9-1">
            <h3>Solution 9-1: My first component using higher order components</h3>

            <MyFirstComponentExtendedWithHigherOrderComponents />
          </div>

          <div className="chapter-2-9-1">
            <h3>Solution 9-2: My first component using wrapper components</h3>
